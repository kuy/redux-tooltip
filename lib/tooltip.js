  ...
  _createClass(Tooltip, [{
    ...
    value: function componentWillUpdate(nextProps) {
      ...
      if (el && this.props.el != el) {
        var tip = (0, _utils.position)(this.refs.tooltip);
        var pos = (0, _utils.position)(nextProps.el);
        this.setState({
    ...
    value: function render() {
      ...
      var style = {
        ...
        arrow: _extends({}, styles.arrow.base),
        border: _extends({}, styles.border.base, styles.border.top, themes.simple.border)
      };
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          'div',
          { style: style.arrow },
          _react2.default.createElement('span', { style: style.border })
        )
      );
    }
  }]);
